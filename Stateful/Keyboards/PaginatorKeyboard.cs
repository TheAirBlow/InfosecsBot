...
/// Paginator keyboard
/// </summary>
public class PaginatorKeyboard : InlineKeyboard {
    /// <summary>
    ...
    public PaginatorKeyboard(UpdateHandler handler, int perPage = 5, params string[] buttons) 
        : base(GenerateKeyboard(handler, perPage, buttons.ToDictionary(x => x, x => x), new Dictionary<string, string>())) { }
    ...
    public PaginatorKeyboard(UpdateHandler handler, Dictionary<string, string> buttons, int perPage = 5, Dictionary<string, string>? extra = null) 
        : base(GenerateKeyboard(handler, perPage, buttons, extra ?? new Dictionary<string, string>())) { }
    ...
    private static Dictionary<string, string> GenerateKeyboard(UpdateHandler handler, 
